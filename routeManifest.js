...
@param {String[]} [slug] - optional
    ...
    **/
  ["optionalCatchAll"]: function (id, slug, query = {}) {
    const nodes = [
      ...
      },
      {
        ...
        extension: "tsx",
        componentName: "optionalCatchAll",
      },
    ]
...
@param {String[]} slug - Required
    ...
    @returns {String} - a valid relative Url string
    **/
  ["catchAll"]: function (id, slug, query = {}) {
    const nodes = [
      { nameParsed: "", name: "", dynamic: false, hasDynamicParent: false },
      {
        nameParsed: "id",
